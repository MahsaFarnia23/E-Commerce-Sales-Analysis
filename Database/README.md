...
Each row represents a **single product-level transaction within an order**, enabling granular analysis of sales performance, customer behavior, and profitability drivers.
